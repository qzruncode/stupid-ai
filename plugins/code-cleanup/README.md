...
唯一功能基准是 `docs/product-spec/feature-list.md`。它只写完整产品应该提供什么，不写任何代码或实现信息。任意 AI 只拿这一份文件，就应当能够复刻并验收完整产品。
...
| `/code-cleanup:cleanup` | 以清单为基准持续清理、重构或重写混乱代码 | 实现、测试、必要护栏 | 功能清单 |
